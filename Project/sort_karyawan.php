        ...
        <img src="img/project.png" class="card-img">
            <div class="card-img-overlay">
                <div align="left" class="col-sm-7"><br>
                    <h1 class="display-4">Update absen</h1>
                    <form action="read_hadir.php" method="post">
                    <table>
                    <td><div class="form-group">
                        <input type="text" class="form-control" name="id_karyawan" placeholder="Masukan ID Karyawan">
                        </div>
                        </td>
                    <td> <div class="form-group">
