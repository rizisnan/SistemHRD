        ...
        <img src="img/project.png" class="card-img">
            <div class="card-img-overlay">
                ...
                <div align="left" class="col-sm-7"><br>
                    <h1 class="display-4">Manage kehadiran karyawan</h1>
                    <i>
                    <p>Klik <a style="color:#B3B6B5" href="sort_karyawan.php"> disini </a>untuk kembali ke pencarian</p>
                    </i>
                </div>
            </div>
        </div>
...
<center><table>
    <form method="post" action="update_hadir.php?id_karyawan=<?php echo $id;?>&bulan=<?php echo $_SESSION['bulan'];?>">
            <div class="container">
            ...
            <tr><div class="form-group">
                <td><input type="hidden" class="form-control" name="posisi_karyawan" value="<?php echo $output['posisi_karyawan'];?>"></td>
            </div>
            </tr>

            <tr><div class="form-group">
                <td><label>Absen</label></td>
                <td><input type="text" class="form-control" name="hadir" value="<?php 
