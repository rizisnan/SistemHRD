        ...
        <img src="img/project.png" class="card-img">
            <div class="card-img-overlay">
                <div align="left" class="col-sm-7"><br>
                    <h1 class="display-4">Daftar Gaji Karyawan
            <?php 
            ...
            <?php }}?>
                    ...
                    <i>
                    <p>Klik <a style="color:#B3B6B5" href="sort_gaji.php"> disini</a> untuk kembali</p>
                    </i>
                </div>
            </div>
        </div>
    ...
    ?>
        ...
        <?php 
            ...
            <?php }}?>
                        ...
                        <td>
                        <a class="btn btn-secondary" href="manage_absen.php?id_karyawan=<?php echo $output['id_karyawan'];?>" role="button" >Update absen</a>

                        <a class="btn btn-danger" href="delete_absen.php?id=<?php echo $output['id_karyawan'];?>" role="button">Reset absen</a>
                        </td>
                    </tr>
    <?php } ?>
                </tbody>
