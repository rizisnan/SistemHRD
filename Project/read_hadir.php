        ...
        <img src="img/project.png" class="card-img">
            <div class="card-img-overlay">
                ...
                <div align="left" class="col-sm-7"><br>
                    ...
                    <h1 class="display-4">Daftar Kehadiran Bulan
            <?php 
...
<center><br>
    ...
    <?php 
        ...
        $id_karyawan = $_POST['id_karyawan'];
        $query = mysqli_query($connect, "select * from karyawan k JOIN gaji g USING(id_karyawan) JOIN absen a USING(id_karyawan) where id_karyawan='$id_karyawan'");
    ...
    ?>
        ...
        <?php 
            ...
            <?php }}?>
                        ...
                        <td>
                        <a class="btn btn-secondary" href="manage_hadir.php?id_karyawan=<?php echo $output['id_karyawan'];?>" role="button" >Update absen</a>
                        
                        <a class="btn btn-secondary" href="gaji_karyawan.php?id_karyawan=<?php echo $output['id_karyawan'];?>&session=<?php echo $_SESSION['bulan'];?>" role="button" >Cetak Gaji</a>
                        </td>
                    </tr>
    <?php  ?>
                </tbody>
